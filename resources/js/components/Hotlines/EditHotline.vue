     ...
     <!-- Modal -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="editModalTitle">Modifier un hotline</h5>
              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" id="nom" class="form-control" placeholder="Nom" v-model="hotlineToEdit.nom">
                  </div>
                  <div class="form-group">
                    <label for="prenom">Prenom</label>
                    <input type="text" id="prenom" class="form-control" placeholder="prenom" v-model="hotlineToEdit.prenom">
                  </div>
                  <div class="form-group">
                    <label for="email">Email</label>
                    <input type="email" id="email" class="form-control" placeholder="email" v-model="hotlineToEdit.email">
                  </div>
                  <div class="form-group">
                    <label for="pseudo">Pseudo</label>
                    <input type="pseudo" id="pseudo" class="form-control" placeholder="pseudo" v-model="hotlineToEdit.pseudo">
                  </div>
                  <div class="form-group">
                    <label for="tel">téléphone</label>
                    <input type="tel" id="tel" class="form-control" placeholder="tel" v-model="hotlineToEdit.tel">
                  </div>
                  <div class="form-group">
         ...
         methods: {
            update(){
                axios.patch('http://localhost:8000/hotlines/edit/' + this.hotlineToEdit.id, {
                    nom: this.hotlineToEdit.nom,
                    prenom: this.hotlineToEdit.prenom,
                    tel: this.hotlineToEdit.tel,
                    email: this.hotlineToEdit.email,
                    pseudo: this.hotlineToEdit.pseudo,
                    password: this.hotlineToEdit.password,
                })
